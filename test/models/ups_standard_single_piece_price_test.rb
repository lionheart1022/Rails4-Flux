...
class UPSStandardSinglePiecePriceTest < ActiveSupport::TestCase

	 # Filenames
  FILENAME = 'test/price_documents/ups_standard_single_piece_final.xlsx'

	test "UPS Standard Single Piece" do
