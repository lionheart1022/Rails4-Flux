class TNTExpressImportCarrierProduct < TNTGenericCarrierProduct
  ...
  def volume_weight(dimension: nil)
    factor = self.custom_volume_weight_enabled ? self.volume_weight_factor : 5000
  ...
  def service
    return TNTShipperLib::ServiceCodes::International::EXPRESS
  end
end
