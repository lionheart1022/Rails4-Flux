class Companies::Shipments::CreateAssetAwbFromS3 < ApplicationInteractor
  ...
  def run
    ...
    Asset.transaction do
      ...
      @asset   = shipment.create_or_update_awb_asset(filepath: @filepath, filename: @filename, filetype: @filetype)
    end
