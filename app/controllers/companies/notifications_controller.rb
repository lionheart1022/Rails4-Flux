class Companies::NotificationsController < CompaniesController
  ...
  def update
    ...
    if @email_settings.save
      redirect_to companies_notification_path
    else
      render :edit
    end
  end
  ...
  def email_settings_params
    params.fetch(:email_settings, {}).permit(*EmailSettings::FLAG_ATTRIBUTES_FOR_COMPANY_USER)
  end
